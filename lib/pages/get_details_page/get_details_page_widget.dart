...
import 'get_details_page_model.dart';
export 'get_details_page_model.dart';

class GetDetailsPageWidget extends StatefulWidget {
  const GetDetailsPageWidget({super.key});

  @override
  State<GetDetailsPageWidget> createState() => _GetDetailsPageWidgetState();
}

class _GetDetailsPageWidgetState extends State<GetDetailsPageWidget> {
  late GetDetailsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetDetailsPageModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createBuyersRecordData(
                        displayName: _model.nameTextController4.text,
                        photoUrl: _model.uploadedFileUrl,
                        phoneNumber: _model.nameTextController5.text,
                        phoneNumber2: _model.nameTextController6.text,
                        firstName: _model.nameTextController1.text,
                        middleName: _model.nameTextController2.text,
                        lastName: _model.nameTextController3.text,
                      ));
