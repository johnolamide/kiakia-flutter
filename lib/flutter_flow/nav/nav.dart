...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'vendorPage',
          path: '/vendorPage',
          builder: (context, params) => VendorPageWidget(
            vendorRef: params.getParam(
              'vendorRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['vendors'],
            ),
          ),
        ),
        FFRoute(
          name: 'emptyPage',
          path: '/emptyPage',
          builder: (context, params) => const EmptyPageWidget(),
        ),
        FFRoute(
          name: 'orderSummaryPage',
          path: '/orderSummaryPage',
          builder: (context, params) => OrderSummaryPageWidget(
            itemsAmount: params.getParam(
              'itemsAmount',
              ParamType.double,
            ),
            deliveryAddress: params.getParam(
              'deliveryAddress',
              ParamType.String,
            ),
            vendorRef: params.getParam(
        ...
        FFRoute(
          ...
          builder: (context, params) => const VerifyTransactionWidget(),
        ),
        FFRoute(
          name: 'itemPage',
          path: '/itemPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => const PersonalInfoPageWidget(),
        ),
        FFRoute(
          name: 'addressPage',
          path: '/addressPage',
        ...
        FFRoute(
          name: 'getDetailsPage',
          path: '/getDetailsPage',
          builder: (context, params) => const GetDetailsPageWidget(),
        )
